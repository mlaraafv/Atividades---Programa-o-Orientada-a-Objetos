...
def main():
    ...
    print("{}\t{}\t   {}    \t{}\t\t {}".format(it1.getSequencial(), p1.getDescricao(), it1.getQuantidade(), p1.getValorUnitario(),it1.getPreço()))
    print("{}\t{}\t   {}    \t{}\t\t {}".format(it2.getSequencial(), p2.getDescricao(), it2.getQuantidade(), p2.getValorUnitario(),it2.getPreço()))
    print("{}\t{}\t   {}    \t{}\t\t {}".format(it3.getSequencial(), p3.getDescricao(), it3.getQuantidade(), p3.getValorUnitario(),it3.getPreço()))
